...
bias_mode ='H'
bias_pot_fluctz,z_start,zstart_window,numz_windows,zwindow_step_size=0.0,z_start_min,0,1,1.0
bias_pot_fluctH,H_start,Hstart_window,numH_windows,Hwindow_step_size=1.0,0.024,0,48,0.001
window_conf_interval=num_moves/100
window_antab_data_interval=num_moves/80000
...
for blen_scale_factor in blen_fac:
	...
	for nab in num_antibody:
		...
		for ens in range(start_ens,end_ens):
			...
			fp.write('#PBS -q long\n')
                        fp.write('#PBS -l walltime=48:00:00\n')
