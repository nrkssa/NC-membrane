...
# fortran variables
antigen_density  = 0.0002                  # 0.002 -> 2000 antigens per micron^2
...
zvalues=[84.5,82.9,81.3,79.7,78.1]
...
for z_start_min in zvalues:
	...
	bias_pot_fluctz,z_start,zstart_window,numz_windows,zwindow_step_size=2.0,z_start_min,0,1,0.1
