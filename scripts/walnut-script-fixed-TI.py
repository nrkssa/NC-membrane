...
#zvalues=[84.4,84.1,83.8,83.5,83.2,82.9,82.6,82.3,82.0]
zvalues=[84.25,83.95,83.65,83.35,83.05,82.75,82.45,82.15,81.85,81.55,81.25,80.95]
...
codehome=os.getcwd()
exec_name='free_ener_fixed'

if (bias_mode == 'H'):
	dirname1='Fixed_Hbias_N-'+str(N)+"_bl-"+str(init_bond_length)

elif (bias_mode == 'Z'):
	dirname1='Fixed_Rbias_N-'+str(N)+"_bl-"+str(init_bond_length)

elif (bias_mode == 'T'):
	dirname1='Fixed_TI_Rbias_N-'+str(N)+"_bl-"+str(init_bond_length)
...
for z_start_min in zvalues:
	...
	bias_pot_fluctz,z_start,zstart_window,numz_windows,zwindow_step_size=1.0,z_start_min,0,1,1.0
	...
	for blen_scale_factor in blen_fac:
		...
		for nab in num_antibody:
			...
			for ens in range(start_ens,end_ens):
				...
				fp.write('#PBS -q short\n')
	                        fp.write('#PBS -l walltime=4:00:00\n')
