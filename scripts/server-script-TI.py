...
kappa,pressure = 160,0.0                   # kappa, pressure, and the excess surface area parameter
blen_fac=[1.5]
dcd_frequency=1000
...
zvalues=[106.0,105.0,104.0,103.0,102.0,101.0,100.0,99.0]
...
if (bias_mode == 'H'):
	...
	dirname1='Equm_Rbias_N-'+str(N)+"_bl-"+str(init_bond_length)

elif (bias_mode == 'T'):
	dirname1='TI_Rbias_N-'+str(N)+"_bl-"+str(init_bond_length)
...
for z_start_min in zvalues:
	...
	bias_pot_fluctz,z_start,zstart_window,numz_windows,zwindow_step_size=1.0,z_start_min,0,1,0.2
